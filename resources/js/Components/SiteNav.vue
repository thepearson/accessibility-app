<template>
<div class="h-full p-3 space-y-2 w-full bg-white text-gray-800">
  <div class="divide-y divide-gray-300">
    <ul class="pt-2 pb-4 space-y-1 text-sm">
      <li v-bind:class="[route().current('sites.show') ? 'bg-blue-200 text-gray-900' : '']">
        <inertia-link :href="route('sites.show', {id: current})" class="flex items-center p-2 space-x-3 rounded-md">
          <svg
      ...
      <li v-bind:class="[route().current('sites.scans') ? 'bg-blue-200 text-gray-900' : '']">
        <inertia-link :href="route('sites.scans', { id: current })" class="flex items-center p-2 space-x-3 rounded-md">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="w-5 h-5 fill-current text-gray-600"
      ...
      <li v-bind:class="[route().current('sites.accessibility') ? 'bg-blue-200 text-gray-900' : '']">
        <inertia-link :href="route('sites.accessibility', {id: current})" class="flex items-center p-2 space-x-3 rounded-md">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="w-5 h-5 fill-current text-gray-600"
      ...
      <li v-bind:class="[route().current('sites.performance') ? 'bg-blue-200 text-gray-900' : '']">
        <inertia-link :href="route('sites.performance', {id: current})" class="flex items-center p-2 space-x-3 rounded-md">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="w-5 h-5 fill-current text-gray-600"
      ...
      <li v-bind:class="[route().current('sites.urls.list') ? 'bg-blue-200 text-gray-900' : '']">
        <inertia-link :href="route('sites.urls.list', { id: current })" class="flex items-center p-2 space-x-3 rounded-md">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="w-5 h-5 fill-current text-gray-600"
